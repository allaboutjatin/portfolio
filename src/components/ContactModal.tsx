...
export const ContactModal: React.FC<ContactModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    ...
    >
      ...
      <div 
        className="fixed inset-0 bg-black/65 backdrop-blur-2xl transition-opacity"
        onClick={() => {
          soundFx.playClick();
          onClose();
        }} 
      ...
      <div 
        className="relative w-full max-w-lg rounded-[32px] overflow-hidden border border-white/20 shadow-[0_25px_80px_rgba(0,0,0,0.85),inset_0_1px_1px_rgba(255,255,255,0.4)] bg-gradient-to-b from-white/[0.14] via-[#12141a]/90 to-[#08090c]/95 backdrop-blur-3xl text-white p-7 sm:p-9 z-10 animate-in zoom-in-95 duration-250"
      ...
      >
        ...
        <div className="flex items-start justify-between relative z-10 mb-6">
          ...
          <button
            ...
            className="w-8 h-8 rounded-full bg-white/10 hover:bg-white/20 border border-white/15 flex items-center justify-center text-slate-300 hover:text-white transition-all cursor-pointer shadow-sm"
        ...
        <div className="relative z-10 space-y-3.5 mb-6">
          ...
          >
            ...
            <span className="text-xs font-mono-code px-3 py-1 rounded-full bg-emerald-500/20 border border-emerald-400/30 text-emerald-300 font-semibold">
              Connect →
            </span>
          </a>

          {/* Email Direct Channel */}
          <div className="p-4 rounded-2xl bg-white/[0.05] border border-white/12 backdrop-blur-md flex items-center justify-between gap-3">
            ...
            <div className="flex items-center space-x-1.5 shrink-0">
              <button
                ...
                className="p-2 rounded-xl bg-white/10 hover:bg-white/20 border border-white/15 text-slate-200 hover:text-white transition-all cursor-pointer"
                title="Copy Email"
              >
              ...
              <a
                ...
                onClick={() => soundFx.playClick()}
                className="p-2 rounded-xl bg-white text-black hover:bg-slate-200 transition-all font-bold cursor-pointer"
          ...
          <div className="p-4 rounded-2xl bg-white/[0.05] border border-white/12 backdrop-blur-md flex items-center justify-between gap-3">
            ...
            <div className="flex items-center space-x-1.5 shrink-0">
              ...
              <a
                ...
                onClick={() => soundFx.playClick()}
                className="px-3 py-2 rounded-xl bg-white/10 hover:bg-white/20 border border-white/15 text-xs font-mono-code font-bold text-white transition-all cursor-pointer"
                title="Call Directly"
              >
                Call
              </a>
