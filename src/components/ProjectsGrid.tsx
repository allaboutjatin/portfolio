...
export const ProjectsGrid: React.FC<ProjectsGridProps> = ({ onSelectProject }) => {
  ...
  return (
    <section id="projects-section" className="py-12 sm:py-24 relative z-10 bg-black text-white border-t border-white/10 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <motion.div 
            ...
            className="font-mono-code text-[11px] sm:text-xs text-slate-300 bg-white/5 border border-white/15 px-3.5 py-1.5 sm:px-4 sm:py-2 rounded-xl sm:rounded-2xl w-fit"
          >
            <span className="text-white font-bold">{PROJECTS_DATA.length}</span> PROJECTS AVAILABLE
          </motion.div>
        </motion.div>

        {/* Projects Bento Grid with Staggered Motion Reveal */}
        <motion.div 
            ...
            return (
              ...
              >
                <BorderGlow
                  ...
                  className="group cursor-pointer hover:-translate-y-1 active:scale-[0.98] transition-all duration-300 w-full"
                >
