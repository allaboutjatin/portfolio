  ...
  return (
    <>
      ...
      >
        ...
        <div
          className="absolute top-0 left-0 isolate -z-10 h-full w-full overflow-hidden rounded-full bg-white/5 backdrop-blur-md"
          style={{ backdropFilter: 'url("#container-glass")' }}
        />

        <div className="pointer-events-none z-10 flex items-center justify-center gap-1.5 font-mono-code font-semibold tracking-wider uppercase text-slate-100">
          {children}
        </div>
        <GlassFilter />
      </Comp>
...
> = {
  default: {
    ...
    button: "bg-gradient-to-b from-[#3a3a3c] via-[#242426] to-[#141416]",
...
const metalButtonVariants = (
  ...
  return {
    wrapper: cn(
      "relative inline-flex transform-gpu rounded-full p-[1.25px] will-change-transform shadow-md",
      colors.outer,
    ),
    wrapperStyle: {
      transform: isPressed
    ...
    button: cn(
      "relative z-10 m-[1px] rounded-full inline-flex h-9 sm:h-10 transform-gpu cursor-pointer items-center justify-center overflow-hidden px-4 sm:px-5 py-1.5 sm:py-2 text-xs sm:text-sm font-mono-code leading-none font-semibold will-change-transform outline-none tracking-wider uppercase backdrop-blur-md",
      colors.button,
      colors.textColor,
      colors.textShadow,
    ),
...
>(({ children, className, variant = "default", ...props }, ref) => {
  ...
  const variants = metalButtonVariants(
    (variant as ColorVariant) || "default",
    isPressed,
    isHovered,
    isTouchDevice,
  );
